          ...
          <div className="relative">
            <div className="flex items-center justify-between gap-4 py-4 sm:gap-6">
              ...
              <div className="flex shrink-0 items-center gap-2 sm:gap-5">
                <nav
                  className="hidden gap-7 text-sm uppercase tracking-[0.19rem] text-black/70 md:flex"
                  aria-label="Primary"
                >
            ...
            <nav
              ...
              className={
                mobileNavOpen
                  ? "border-t border-black/10 pb-3 md:hidden"
                  : "hidden md:hidden"
              }
              aria-label="Primary"
            >
          ...
          <div className="border-t border-black/10">
            {t.process.steps.map((step, index) => (
              ...
              >
                ...
                <p className="text-base leading-8 text-black/65 sm:leading-7 md:col-span-8 md:pt-1">
                  {step.text}
                </p>
              </article>
            ))}
